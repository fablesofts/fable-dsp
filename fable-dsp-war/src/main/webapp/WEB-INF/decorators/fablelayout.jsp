...
<div class="container">
                ...
                <div class="userMsg">
                		...
                		<div class="userMsgSec">
                        	<ul>
                              ...
                              <li><a href="${ctx}/j_spring_security_logout" title="注销用户" class="easyui-tooltip"><img src="${pageContext.request.contextPath}/style/images/main/exit.gif"  align="absmiddle" />&nbsp;退出</a></li>
                            </ul>
                         </div>
                </div>
                <!-- end .userMsg -->
        ...
        <div class="sidebar1" id="frmTitle">
              ...
              <ul class="nav">
         <li class="firLi"  ><a href="javascript:void(0)"><img src="${pageContext.request.contextPath}/style/images/main/icon1.gif"  align="middle" />&nbsp;&nbsp;首页</a></li>
                    	
                    <li class="firLi"  ><a href="javascript:void(0)"><img src="${pageContext.request.contextPath}/style/images/main/icon2.gif"  align="middle"  />&nbsp;&nbsp;数据交换</a></li>
                    	<ul  class="hdUl"  >
							<li class="hdLi">
								<a href="${ctx}/dataswitch/task-maintain">任务管理</a>
							</li>
							<li class="hdLi"><a href="${ctx}/networkCfg/network_new">网络配置</a></li>
							<li class="hdLi"><a href="${ctx}/dataSource/maintain">数据资源配置</a></li>
                    ...
                    <li class="firLi"  ><a href="javascript:void(0)"><img src="${pageContext.request.contextPath}/style/images/main/icon3.gif"   align="middle" />&nbsp;&nbsp;系统服务</a></li>
                    	<ul  class="hdUl" >
							<li class="hdLi"><a href="${ctx}/ftpservice/ftp-maintain">FTP用户管理</a></li>
							<li class="hdLi"><a href="${ctx}/ftp/ftp-mapping">FTP映射目录管理</a></li>
						</ul>
                    <li class="firLi"  ><a href="javascript:void(0)"><img src="${pageContext.request.contextPath}/style/images/main/icon4.gif"   align="middle" />&nbsp;&nbsp;日志审计</a></li>   
                    	<ul  class="hdUl" >
							<li class="hdLi"><a href="${ctx}/userOperationLog/maintain">用户操作日志</a></li>
							<li class="hdLi"><a href="${ctx}/systemLog/maintain">系统日志</a></li>
						</ul>
                     <li class="firLi"  ><a href="javascript:void(0)"><img src="${pageContext.request.contextPath}/style/images/main/icon11.gif"   align="middle" />&nbsp;&nbsp;系统管理</a></li> 
                     	<ul  class="hdUl" >
