...
<body>
        	<!-- begin .location --> 
	          	<div class="location">        
	                <span><img src="${pageContext.request.contextPath}/style/images/main/home.gif"  /></span>
	                  	<ul>
	                    	<li class="part"><img src="${pageContext.request.contextPath}/style/images/main/line--.gif"  align="absmiddle"/></li>
	                    	<li class="locationName locationName_4">帮助</li>
	                          <li class="part"><img src="${pageContext.request.contextPath}/style/images/main/line--.gif"  align="absmiddle"/></li>
	                    	<li class="locationName locationName_4">DEMO示例</li>
	                    </ul>	
	           	</div>
          	<!-- end .location -->
            ...
            <!-- begin .conditions -->	
             <div class="conditions">
                     <p class="conditionOne">查询条件：<input type="text"   class="inputs"/></p>
                     <p class="conditionOne">查询条件：<input type="text"   class="inputs"/></p>
                     <p class="conditionOne">查询条件：<input type="text"   class="inputs"/></p>
                     <p class="conditionOne">查询条件：<input type="text"   class="inputs"/></p>
                     <p class="conditionOne">查询条件：<input type="text"   class="inputs"/></p>
                     ...
                     <p class="conditionsBtn">
        					<a href="#" class="fltrt">重置</a>
                        	<a href="#" class="fltrt">查询</a>
                     </p>
             </div>
            <!-- end .conditions -->
