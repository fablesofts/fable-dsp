...
import com.fable.dsp.core.annotation.LogAnnotation;
import com.fable.dsp.core.page.Page;
import com.fable.dsp.core.page.PageList;
import com.fable.dsp.dao.system.user.intf.RoleInfoDao;
...
import com.fable.dsp.service.system.user.intf.UserInfoService;
...
public class UserInfoServiceImpl implements UserInfoService {
    ...
    //
    @LogAnnotation(keyIndex = { 1 }, operationDescribe = { "用户管理操作日志：插入一条用户记录" },
                    operationType = { '0' }, primaryKey = { "id" }, targetName = { "sys_user_info-username" },
                    userIndex = 1)
    @Override
