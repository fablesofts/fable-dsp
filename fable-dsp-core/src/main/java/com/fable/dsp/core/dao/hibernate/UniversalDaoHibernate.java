package com.fable.dsp.core.dao.hibernate;
...
public class UniversalDaoHibernate extends HibernateDaoSupport implements UniversalDao {
	...
	private static final Logger   logger = LoggerFactory.getLogger(UniversalDaoHibernate.class);
    ...
    public void insert(Object entity) {
        if (entity instanceof AuditEntity) {
            ((AuditEntity) entity).setCreateTime(new Date());
        }
    ...
    public void update(Object entity) {
        if (entity instanceof AuditEntity) {
            ((AuditEntity) entity).setUpdateTime(new Date());
        }
